const ComponentStyles = {
    ...
    mainHeading: "oswald-title text-4xl mb-6 text-center",
    searchForm: "max-w-[320px] mx-auto mb-8",
    resultWrapper: "border-t-2 border-zinc-800 p-4 flex flex-col items-center gap-",
