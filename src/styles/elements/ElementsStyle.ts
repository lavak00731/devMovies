const ElementStyle = {
    ...
    btn: "block rounded text-center w-full bg-sky-800 text-base px-2 py-1 text-zinc-50 border-2 border-sky-800 font-bold .libertinus-sans-regular hover:bg-zinc-50 hover:text-sky-800 focus-visible:bg-zinc-50 focus-visible:text-sky-800 libertinus-sans-bold text-center",
    ...
    subtitle: "text-center oswald-title text-3xl text-zinc-800 text-balance mb-4",
